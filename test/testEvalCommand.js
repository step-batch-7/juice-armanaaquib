...
describe("Testing evalQuery", function() {
    ...
    it("should give morte than one transactions if beverage is matched", function() {
        const transactionRecords = [
            { empId: 25275, beverage: "papaya", qty: 1, date: "2019-11-25T10:35:45.860Z" },
            { empId: 25275, beverage: "watermelon", qty: 2, date: "2019-11-26T10:40:40.480Z" },
            { empId: 25346, beverage: "papaya", qty: 1, date: "2019-11-25T10:54:17.069Z" }
        ];
    ...
    it("should give transactions if beverage and date both are matched", function() {
        const transactionRecords = [
            { empId: 25275, beverage: "papaya", qty: 1, date: "2019-11-25T10:35:45.860Z" },
            { empId: 25275, beverage: "papaya", qty: 2, date: "2019-11-25T10:40:40.480Z" },
            { empId: 25346, beverage: "pineapple", qty: 1, date: "2019-11-25T10:54:17.069Z" }
        ];
    ...
    it("should give transactions if beverage, empId and date all are matched", function() {
        const transactionRecords = [
            { empId: 25275, beverage: "papaya", qty: 1, date: "2019-11-25T10:35:45.860Z" },
            { empId: 25274, beverage: "papaya", qty: 2, date: "2019-11-25T10:40:40.480Z" },
            { empId: 25346, beverage: "pineapple", qty: 1, date: "2019-11-25T10:54:17.069Z" }
        ];
